    ...
    export class MultiLightScreenEffect implements effects.BackgroundEffect {
        ...
        startScreenEffect() {
            ...
            scene.createRenderable(91, () => {
                ...
                // 0. prepare a empty light map with maximum brightness
                let lightMap = image.create(screen.width, screen.height)
                lightMap.fill(15)  // 15 represents maximum brightness

                // 1. apply light map to screen
                this.applyLightMapToScreen(lightMap)

                // 2. prepare light map for each light source
